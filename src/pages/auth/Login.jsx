...
import { FaArrowLeft, FaTree, FaEnvelope, FaLock, FaGoogle, FaArrowRight } from 'react-icons/fa';
...
const Login = () => {
  ...
  const handleLogin = (e) => {
    ...
    setTimeout(() => {
      ...
      else if (email.includes('guide')) navigate('/guide');
      else navigate('/'); 
    }, 1500);
  };
  ...
  return (
    ...
    <div className="h-screen w-full bg-[#E2E6D5] text-[#2B3326] font-['Poppins'] flex items-center justify-center relative overflow-hidden">
      ...
      <motion.div 
        ...
        // FIXED: w-full, h-full for mobile, max-h-[85vh] for desktop to ensure it floats nicely
        // max-w-6xl keeps it contained horizontally.
      ...
      >
        ...
        <div className="w-full lg:w-[45%] h-full p-8 md:p-12 flex flex-col justify-center relative bg-[#F3F1E7]">
           ...
           {/* 'self-start' aligns it left on mobile. 'lg:top-12 lg:left-12' matches the container padding on desktop. */}
           <Link 
             to="/" 
